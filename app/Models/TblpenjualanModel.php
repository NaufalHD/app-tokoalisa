...
class TblpenjualanModel extends Model
{
    ...
    protected $allowedFields = ['invoice', 'nm_kostumer', 'nm_kostumer_id', 'is_hutang', 'total_harga', 'diskon', 'harga_final', 'tunai', 'kembalian', 'catatan', 'user_id', 'tanggal', 'created_at'];
