...
class ItemNotaPembelianModel extends Model
{
    protected $table = 'item_notapembelian';
    ...
    protected $allowedFields = ['itemnota_notaid', 'itemnota_date', 'itemnota_namabarang', 'itemnota_jumlahbarang', 'itemnota_nominaltransaksi', 'itemnota_catatan'];
    // protected $primaryKey = 'id';



    public function getItemNota($itemnota_id = false)
    {
        ...
        if ($itemnota_id == false) {
            ...
            return $this->where(['itemnota_id' => $itemnota_id])->first();
        }
    }
    ...
    public function fiturCari($keyword)
    {
        ...
        return $this->like('itemnota_notaid', $keyword)->orLike('itemnota_namabarang', $keyword)->orLike('itemnota_jumlahbarang')->orLike('itemnota_nominaltransaksi')->orLike('itemnota_catatan')->findAll();
