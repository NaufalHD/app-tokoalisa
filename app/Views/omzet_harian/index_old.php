...
<div class="container">
    ...
    <div class="row">
        <div class="col">
            <a href="/omzet_harian/create" class="btn btn-primary mt-3">Tambah Omzet Harian</a>
            ...
            <table class="table">
                <thead>
                    <tr>
                        <th scope="col">Omzet ID</th>
                        <th scope="col">Omzet Date</th>
                ...
                <!-- dibawah ini tbody utk data2 yang sifatnya non-object seperti punyaku dewe -->
                <tbody>
                    <?php foreach ($data_row as $d) : ?>
                        <tr>
                            <td><?= $d['omzet_id']; ?></td>
                            <td><?= $d['omzet_date']; ?></td>
                            <td><?= $d['omzet_nominal'] / 1000; ?></td>
                            <!-- <td><//?= strtolower($d['omzet_catatan']); ?></td> -->
                            <td><?= $d['omzet_catatan']; ?></td>
                            <td>
                                <form action="/omzet_harian/edit/<?= $d['omzet_id']; ?>" method="get" class="d-inline">
                                    <?= csrf_field(); ?>
                                ...
                                <!-- </td> -->
                                <!-- <td> -->
                                <form action="/omzet_harian/<?= $d['omzet_id']; ?>" method="post" class="d-inline">
                                    <?= csrf_field(); ?>
